...
==================================================================
     ...
     original Micropather.cpp file. The modified parts are 
     licensed according to the RobotJoint license, the original 
     parts are licensed under the 'BSD' license. 
     The original Micropather code was developed 
     by Lee Thomason (www.grinninglizard.com), read the 
